...
struct MeasureGroup     // Lidar data and imu dates for the curent process
{
    MeasureGroup()
    {
        ...
        this->nearfield.reset(new PointCloudXYZI());
    };
    double lidar_beg_time;
    double lidar_last_time;
    PointCloudXYZI::Ptr lidar;
    // Near-field points for this scan (see Point-LIO near-field deskew extension).
    // Same curvature (offset-time, ms) convention as `lidar`.
    PointCloudXYZI::Ptr nearfield;
