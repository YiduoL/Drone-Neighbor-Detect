...
def generate_launch_description():
    ...
    laser_mapping_params = [
        ...
        ]),
        {
            ...
            'check_satu': True,
            'init_map_size': 10,
            # NOTE: point_filter_num / space_down_sample / filter_size_surf used to be
            # hardcoded here, which silently overrode whatever mid360.yaml said (this list
            # is parsed in order and later entries win). Removed so mid360.yaml is the one
            # source of truth for these -- see mid360.yaml's own point_filter_num /
