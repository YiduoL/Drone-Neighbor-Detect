...
extern bool use_surfel_map;
extern double surfel_map_voxel_size;
extern int surfel_map_min_points;
extern double surfel_map_warmup_seconds;
extern int ekf_group_batch;
extern int ekf_update_stride;
...
extern bool nearfield_publish_world, nearfield_publish_raw;

// OS-Deskew C2: fixed-lag RTS smoother refinement of near-field output points.
extern bool os_deskew_enable;
extern double os_deskew_lag;
extern double os_deskew_node_hz;
extern double os_deskew_q_pos_accel, os_deskew_r_pos, os_deskew_r_vel;
extern double os_deskew_q_rot, os_deskew_r_rot;
extern double os_deskew_retention_margin;
