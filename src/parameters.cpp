...
float plane_thr;
bool use_surfel_map;
double surfel_map_voxel_size;
int surfel_map_min_points;
double surfel_map_warmup_seconds;
int ekf_group_batch;
int ekf_update_stride;
...
bool nearfield_publish_world = true, nearfield_publish_raw = true;

bool os_deskew_enable = false;
double os_deskew_lag = 0.1;
double os_deskew_node_hz = 1000.0;
double os_deskew_q_pos_accel = 4.0, os_deskew_r_pos = 4e-4, os_deskew_r_vel = 1e-2;
double os_deskew_q_rot = 0.5, os_deskew_r_rot = 1e-4;
double os_deskew_retention_margin = 0.05;
...
void readParameters(shared_ptr<rclcpp::Node> &nh) {
    ...
    nh->declare_parameter<bool>("mapping.use_surfel_map", false);
    nh->declare_parameter<double>("mapping.surfel_map_voxel_size", 0.5);
    nh->declare_parameter<int>("mapping.surfel_map_min_points", 5);
    nh->declare_parameter<double>("mapping.surfel_map_warmup_seconds", 10.0);
    nh->declare_parameter<int>("mapping.ekf_group_batch", 1);
    nh->declare_parameter<int>("mapping.ekf_update_stride", 1);
    ...
    nh->declare_parameter<double>("os_deskew.q_pos_accel", 4.0);
    nh->declare_parameter<double>("os_deskew.r_pos", 4e-4);
    nh->declare_parameter<double>("os_deskew.r_vel", 1e-2);
    nh->declare_parameter<double>("os_deskew.q_rot", 0.5);
    ...
    nh->get_parameter("mapping.use_surfel_map", use_surfel_map);
    nh->get_parameter("mapping.surfel_map_voxel_size", surfel_map_voxel_size);
    nh->get_parameter("mapping.surfel_map_min_points", surfel_map_min_points);
    nh->get_parameter("mapping.surfel_map_warmup_seconds", surfel_map_warmup_seconds);
    nh->get_parameter("mapping.ekf_group_batch", ekf_group_batch);
    nh->get_parameter("mapping.ekf_update_stride", ekf_update_stride);
    ...
    nh->get_parameter("os_deskew.q_pos_accel", os_deskew_q_pos_accel);
    nh->get_parameter("os_deskew.r_pos", os_deskew_r_pos);
    nh->get_parameter("os_deskew.r_vel", os_deskew_r_vel);
    nh->get_parameter("os_deskew.q_rot", os_deskew_q_rot);
    nh->get_parameter("os_deskew.r_rot", os_deskew_r_rot);
    nh->get_parameter("os_deskew.retention_margin", os_deskew_retention_margin);
}
